      ...
      <el-container class="common-main">
          ...
          <div class="outBox">
            <div class="header">
              <el-row>
                ...
                <el-col :span="1" class="countBox">
                  <a
                    @click="pushCount('collection',detail.isLike,detail.userVO.id,detail.id,detail.title,userId)"
                  >
                    <svg
                      t="1591091670249"
                      class="icon"
                    ...
                    >
                      <path
                        ...
                        p-id="3688"
                        :fill="detail.isCollection ? '#ea6f5a' : '#646464'"
                      />
                    </svg>
                    {{detail.joinCount}}
                  </a>
                ...
                <el-col :span="1" class="countBox">
                  <span @click="comment(detail.userVO.id,detail.id,userId)">
        ...
        <div class="contentBox" ref="contentBox" @scroll="listenScroll($event)">
          ...
          <el-card class="commentBox">
            ...
            <p v-else class="last" style="text-align: center; color:#b4b4b4">
              还没有评论快来抢沙发...
              <span @click="comment(detail.userVO.id,detail.id,userId)">
                <i class="el-icon-chat-dot-round"></i>
              </span>
...
export default {
  ...
  methods: {
    ...
    comment(toUserId, postId, userId) {
      var params = {
        content: "", //内容
        parentId: 0,
        postId: postId, //文章id
        toUserId: toUserId, //评论用户id
