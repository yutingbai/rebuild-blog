  ...
  <div class="login_body">
    <div class="loginbox">
      ...
      <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" class="signup-ruleForm">
        ...
        <el-form-item prop="code" v-if="ruleForm.email != ''">
          <el-input
            type="code"
            :hide-required-asterisk="false"
            ...
            placeholder="请输入验证码"
          ></el-input>
          <div class="clickbtn" :disabled="disabled" @click="handleToVerify(ruleForm.email)">{{ verifyInfo }}</div>
        </el-form-item>
        ...
        <el-form-item>
          <el-button class="login_btn" type="primary" @click="handleToRegister('ruleForm')">注册</el-button>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleToRegister(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          API.Register(Object.assign(this.ruleForm)).then(res => {
            console.log(res);
            if (res.code == 0) {
