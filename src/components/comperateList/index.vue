  ...
  <div class="content">
    <div class="userCenter">
      <div class="wordList">
        <el-row :gutter="20">
          <el-col :span="2.5">
            <router-link tag="div" to="/comperate/all">全部</router-link>
          </el-col>
          <el-col :span="2.5">
            <router-link tag="div" to="/comperate/team">找队友</router-link>
          </el-col>
          <el-col :span="2.5">
            <router-link tag="div" to="/comperate/item">找项目</router-link>
          </el-col>
        </el-row>
      </div>
    </div>
